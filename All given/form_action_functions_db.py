...
def db_list(form, db, cur):
    ...
    if form.keys().__contains__("variable_1") and form.keys().__contains__("variable_2") and form.keys().__contains__("variable_3"):
        ...
        cur.execute("""INSERT INTO `db_list` (`id`, `db_variable_1`, `db_variable_2`, `db_variable_3`) 
        VALUES ('%s', '%s', '%s', '%s')""" % ('NULL' , form["variable_1"].value, form["variable_2"].value , form["variable_3"].value))
        db.commit()
